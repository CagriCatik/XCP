## Kapitel 1: Die XCP-Protokollschicht im Detail
...
### 1.6 Detaillierte Analyse der Paketfelder
...
#### 1.6.3 Timestamp Field (Zeitstempelfeld)
...
##### 1.7.2.3 Beispielhafter STIM-Ablauf
